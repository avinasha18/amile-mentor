            ...
            <Sidebar>
                <div className="flex-1">
                    <SidebarItem 
                        ...
                        icon={<CgProfile />}
                        onClick={() => {handleItemClick("Profile"); nav("/profile")}}
                    />
                    <SidebarItem 
                        text="Students" 
                        icon={<PiListChecks />}
                        active={activeItem === "Students"}
                        onClick={() => {handleItemClick("Students"); nav("/students")}}
                    />
                    <SidebarItem 
                        text="AI Interviewer" 
                        icon={<FaMailchimp />}
                        active={activeItem === "Interview"}
                        onClick={() => {handleItemClick("Interview"); nav("/aimock")}}
                    />
                    <SidebarItem 
                        text="Inventory" 
                        icon={<GiBookshelf />}
                        ...
                        alert
                        onClick={() => {handleItemClick("Inventory"); nav("/courses")}}
                    />
                    <SidebarItem 
                        text="Help" 

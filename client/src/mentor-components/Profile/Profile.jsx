...
const MentorProfile = () => {
        ...
        {hasCertifications ? (
          <>
            <div>
              ...
              <p className="text-md">
                Date of Issue: {certification?.issueDate}
              </p>
              <p className="text-md">
  ...
  return (
    <div
      className={`min-h-screen p-8 overflow-auto w-full bg-black ${themeStyles.background}`}
    >
      <div className="max-w-6xl mx-auto flex flex-col gap-1 mb-10">
        <div className="flex flex-shrink-0 gap-10">
          {/* Profile Section */}
          <div
            className={`rounded-lg p-6 mb-8 w-3/4 backdrop-blur-lg ${themeStyles.card} bg-opacity-50 shadow-lg border border-slate-500/30`}
          >
          ...
          {/* Social Media */}
          <div
            className={`rounded-lg p-6 mb-8 w-1/4 backdrop-blur-lg ${themeStyles.card} ${themeStyles.text} bg-opacity-50 shadow-lg border border-slate-500/30`}
          >
        ...
        <div className="rounded-lg w-full mb-16 ">
              ...
              {tabs.map((tab, index) => (
                <li key={index}>
                  <button
                    ...
                    className={`${themeStyles.text} px-10 py-2 rounded-t-md ${
                      themeStyles.tab
                    } ${
                      activeTab === themeStyles.tabActive
          ...
          <div
            className={`backdrop-blur-lg ${themeStyles.card} ${themeStyles.text} bg-opacity-50 shadow-lg border border-slate-500/30 py-10`}
          >
            {renderTabContent()}
          </div>
        </div>
        ...
        {/* Skills Sections */}
        <div
          className={`rounded-lg p-6 mb-8 w-3/4 backdrop-blur-lg ${themeStyles.card} bg-opacity-50 shadow-lg ${themeStyles.cardBorder}`}
        >
